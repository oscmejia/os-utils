...
// Returns the platform ['aix', 'darwin', 'freebsd', 'linux', 'openbsd', 'sunos' and 'win32']
...
// Returns the free memory as a percentage ((25 / 50) * 100 = 50%)
exports.freeMemoryPercentage = () => (_os.freemem() / _os.totalmem()) * 100;

exports.freeCommand = (callback) =>
{
    if (process.platform === 'win32')
    {
        console.error("\x1b[160mThis function is only for linux!\x1b[0m");
        return;
    }
